    ...
    <div class="card-group">
        <div class="card">
            ...
            <div class="card-body bg-color text-white">
                ...
                <p class="card-text">Activity that enhances or maintains physical fitness and overall health and wellness. It is performed for various reasons, to aid growth and improve strength, prevent aging, develop muscles and the cardiovascular system, hone athletic skills, weight loss or maintenance, improve health, or simply for enjoyment. Many individuals choose to exercise outdoors where they can congregate in groups, socialize, and improve well-being as well as mental health.</p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body bg-color text-white">
                ...
                <p class="card-text">Studies show getting quality sleep on a regular basis can help improve all sorts of issues, from your blood sugar to your workouts. When you're running low on sleep, you'll probably have trouble holding onto and recalling details. That's because sleep plays a big part in both learning and memory. Without enough sleep, it's tough to focus and take in new information. Your brain also doesn't have enough time to properly store memories so you can pull them up later. Sleep lets your brain catch up so you're ready for what's next.</p>
            </div>
        </div>
    </div>
